...
import com.mundox.management.ports.api.http.responses.{DummyMovieResponseDTO, SnackDTO}
...
trait JsonSupport extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val snackResponseDTO: RootJsonFormat[SnackDTO] = jsonFormat3(SnackDTO.apply)
}