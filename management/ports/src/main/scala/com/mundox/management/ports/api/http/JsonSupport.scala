...
import com.mundox.management.ports.api.http.requests.{DummyCreateMovieRequestDTO, SnackRequestDTO}
...
trait JsonSupport extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val snackRequestDTO: RootJsonFormat[SnackRequestDTO] = jsonFormat5(SnackRequestDTO.apply)
}